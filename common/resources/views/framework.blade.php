...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id={{$settings->get('analytics.tracking_code')}}" />
    <script>
...
<body>
    ...
    <div id="root" style="{{ $bootstrapData->getSelectedTheme()->getColorsForCss() }}" @class(['dark'=>
